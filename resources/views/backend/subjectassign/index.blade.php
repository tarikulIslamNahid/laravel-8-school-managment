...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>Subject Assign</span></li>
@endsection
@section('style')
    <style>
        .tabelbox {
                            ...
                            <tbody>
                                @foreach ($assignSubjects as $key => $assign)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('student.fee.amount.edit', $assign->class_id) }}"
                                                class='mr-2'>
                                            ...
                                            <a href="{{ route('student.fee.amount.delete', $assign->class_id) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <a href="{{ route('student.fee.amount.view', $assign->class_id) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round"
