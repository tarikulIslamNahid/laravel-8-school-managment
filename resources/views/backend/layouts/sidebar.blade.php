...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#group" data-toggle="collapse" data-active="{{($route=='student.group' || $route=='student.group.create'|| $route=='student.group.edit') ? 'true' :''}}" aria-expanded="{{($route=='student.group'|| $route=='student.group.create'|| $route=='student.group.edit') ? 'true' :''}}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
            ...
            <li class="menu">
                <a href="#shift" data-toggle="collapse" data-active="{{($route=='student.shift' || $route=='student.shift.create'|| $route=='student.shift.edit') ? 'true' :''}}" aria-expanded="{{($route=='student.shift'|| $route=='student.shift.create'|| $route=='student.shift.edit') ? 'true' :''}}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="fee" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="#feecat" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Fee Category<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                ...
                <ul class="collapse submenu list-unstyled" id="fee" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="#feeAmount" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Fee Amount<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
