...
<li class="breadcrumb-item active" aria-current="page"><span>Classes</span></li>
@endsection
@section('style')
    <style>
      .tabelbox {
        ...
        <div class="row mt-5">
            <div class="col-lg-12 ">
              <div class=" d-flex justify-content-between p-3 statbox tabelbox box box-shadow">
                ...
                <div class="dt-buttons"> <a href="{{route('student.class.create')}}"class="dt-button btn btn-primary btn-sm toggle-vis mb-1"
                    ...
                    <table id="zero-config" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$class->name}}</td>
                                <td>
<a href="{{route('student.class.edit',$class->id)}}"class='mr-2'>
