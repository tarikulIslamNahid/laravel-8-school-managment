                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Create New Student Fee Amount</h4>
                        </div>
                    </div>
                </div>
                <hr>
...
<form class="needs-validation" novalidate action="{{route('student.fee.amount.store')}}" method="post">
    @csrf
<div class="add_item">
    ...
    <div class="form-row mt-4">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" id="validationCustom03" name="amount[]"  :value="old('amount')"  required>
        ...
        <div class="col-md-2">
            <span style="margin-top:34px" class="btn btn-primary mr-2 addeventmore"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></span>
        </div>
  ...
  <div style="visibility: hidden;">
    ...
    <div class="col-md-5">
       ...
       <div class="col-md-2"  >
        ...
        <span style="margin-top:34px" class="btn btn-danger mr-2 removeeventmore"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="8" y1="12" x2="16" y2="12"></line></svg></span>
