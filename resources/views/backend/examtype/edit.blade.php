                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <form class="needs-validation" novalidate
                            action="{{ route('student.examtype.update', $ExamTypes->id) }}" method="post">
                            @csrf
                            ...
                            <button class="btn btn-primary mt-3" type="submit">Update Exam Type</button>
                        </form>
