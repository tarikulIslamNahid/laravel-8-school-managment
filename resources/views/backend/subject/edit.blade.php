...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('student.subject.index') }}">Subject</a></li>
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <form class="needs-validation" novalidate
                            action="{{ route('student.subject.update', $schoolSub->id) }}" method="post">
                            @csrf
                            ...
                            <button class="btn btn-primary mt-3" type="submit">Update Subject</button>
                        </form>
