...
@section('title','Student Gropu')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
<li class="breadcrumb-item active" aria-current="page"><span>Student Group</span></li>
@endsection
@section('style')
    <style>
      .tabelbox {
        ...
        <div class="row mt-5">
            <div class="col-lg-12 ">
              <div class=" d-flex justify-content-between p-3 statbox tabelbox box box-shadow">
                <h4>Student Group List</h4>

                <div class="dt-buttons"> <a href="{{route('student.group.create')}}"class="dt-button btn btn-primary btn-sm toggle-vis mb-1"
                    ...
                    <table id="zero-config" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$group->name}}</td>
                                <td>
<a href="{{route('student.group.edit',$group->id)}}"class='mr-2'>
