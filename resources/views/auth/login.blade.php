...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin')}}/{{asset('admin')}}/assets/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="{{asset('admin')}}/{{asset('admin')}}/assets/css/forms/switches.css">
</head>
<body class="form">

    @if (session('status'))
    <div height='100vh' class="mb-4  font-medium text-sm text-green-600">
                        ...
                        <p class="">Log in to your account to continue.</p>
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    :value="old('email')" required autofocus placeholder="e.g John_Doe">
                                </div>
